...
class AdapterIncome:RecyclerView.Adapter<AdapterIncome.HolderCategory> {



    private  val context:Context
    private val category:ArrayList<IncomeActivity>
    private lateinit var binding:TransactionListItemBinding
    constructor(context: Context, category: ArrayList<IncomeActivity>) {
    ...
    override fun onBindViewHolder(holder: HolderCategory, position: Int) {
        ...
        holder.imageButtonedit.setOnClickListener{
            ...
            builder.setTitle("Edit")
                .setMessage("Are sure want to Edit this Income Detail")
                .setPositiveButton("Conform"){a, d->
                    
                    val intent=Intent(context,EditIncomeActivity::class.java)
...
//
        ...
        holder.deleteimageButton.setOnClickListener{
            ...
            builder.setTitle("Delete")
                .setMessage("Are sure want to delete this Income Detail")
                .setPositiveButton("Conform"){a, d->
                    Toast.makeText(context,"Deleting...",Toast.LENGTH_SHORT).show()
                    deleteincome(model, holder)
    ...
    private fun moreOptionDialog(model: IncomeActivity, holder: AdapterIncome.HolderCategory) {
        val id = model.id
        val amount = model.amount
        val title = model.title
        val category = model.category
    ...
    private fun deleteincome(model: IncomeActivity, holder: HolderCategory) {
